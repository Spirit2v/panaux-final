...
export default class Home12 extends Component<Props> {
  constructor(props) {
    super(props);
    this.state = {
      value: false,
  ...
  render() {
    return (
      <View
        showsVertical
        Indicator={false}
        style={{backgroundColor: colors.theme_bg, height: '100%'}}>
      ...
      //  <Container>  */}
        ...
        <View
          style={{
            ...
            >
            <HomeButton title="Docotr Appointment" pic="calendar-outline" />
            </TouchableOpacity>
